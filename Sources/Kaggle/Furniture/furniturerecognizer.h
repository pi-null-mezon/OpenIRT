#ifndef FURNITURERECOGNIZER_H
#define FURNITURERECOGNIZER_H
...
class FurnitureRecognizer: public CNNImageRecognizer
{
public:
    FurnitureRecognizer(const String &_descriptormodelfile, DistanceType _disttype, double _threshold);
...
Ptr<CNNImageRecognizer> createFurnitureRecognizer(const String &_descriptormodelfile="dlib_furniture_metric_resnet.dat", DistanceType _disttype=DistanceType::Euclidean, double _threshold=DBL_MAX);

}}

#endif // FURNITURERECOGNIZER_H
